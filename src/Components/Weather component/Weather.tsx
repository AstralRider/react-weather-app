  ...
  return (
    <div className="container flex justify-center max-w-2xl mx-auto ">
      {info?.list
        ...
        .map((x) => (
          <div className="flex flex-col rounded shadow-xl outline outline-1 outline-gray-200 px-7 py-6 transition ease-in-out delay-10 max-w-[130px] hover:-translate-y-1 hover:scale-105 mx-1">
